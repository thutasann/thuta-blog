...
function Footer() {
    ...
    return (
        <div className='flex flex-col items-start justify-center py-4 mb-5 border-t border-gray-400 border-opacity-50 md:justify-between md:flex-row md:items-center'>
            <div>
