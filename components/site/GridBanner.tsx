...
function GridBanner() {
    return (
        <div className='grid grid-flow-row-dense grid-cols-3 gap-x-2 gap-y-3 my-[50px]'>
            ...
            {/* NextJS */}
            <div className='relative rounded-lg shadow-xl min-h-[200px] md:min-h-[400px] lg:min-h-[530px] col-span-3'>
                <Image
            ...
            {/* Siwft IOS */}
            <div className='rounded-lg relative shadow-xl min-h-[152px] md:min-h-[380px] lg:min-h-[500px] row-span-2 col-span-2'>
                <Image
