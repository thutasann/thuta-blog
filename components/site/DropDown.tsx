...
export default function DropDown({ openDrawer, setOpenDrawer } : Props ) {
        ...
        <>
            <div className='inline md:hidden'>
                <Menu as="div" className="relative inline-block text-left">
                    ...
                    >
                        <Menu.Items className="absolute left-0 mt-2 text-white origin-top-right bg-gray-600 border-2 border-gray-300 divide-y divide-gray-100 rounded-md shadow-lg w-52 md:w-56 dark:bg-primary-black border-opacity-20">
