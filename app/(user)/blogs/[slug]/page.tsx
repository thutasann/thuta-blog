					...
					<section className="w-full p-5 bg-opacity-20 bg-primary-teal">
						...
						<div className="flex flex-col justify-between gap-y-5">
							<div className="flex flex-col space-y-3">
								...
								<h1 className="text-4xl font-extrabold text-primary-black dark:text-white">
									{post.title}
								</h1>
							</div>
							<div className="flex items-center space-x-2">
								...
								/>
								<div className="w-64">
									<p className="text-lg font-bold text-primary-black dark:text-gray-200">
										{post.author.name}
									</p>
									<div></div>
								</div>
						...
						{/* description */}
						<div className="mt-4">
							<h2 className="mb-3 italic text-primary-black dark:text-white">
								{post.description}
							</h2>
						</div>
						...
						<div className="mt-4">
							...
							<h3 className="text-primary-black dark:text-gray-100">
								Share This Blog To :
							</h3>
							<div className="flex items-center mt-2 space-x-3 text-primary-black dark:text-gray-100">
								...
								<a
									className="icons"
									href={linkedInSharedLink}
									target="_blank"
									rel="noopener"
									aria-label="LinkedIn Shared"
								>
									<AiFillLinkedin />
								</a>
								<a
									className="icons"
									href={twitterSharedLink}
									target="_blank"
									rel="noopener"
